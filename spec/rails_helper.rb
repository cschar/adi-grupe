...
Chromedriver.set_version "2.31"  # needed for headless w/ chrome 61.0

#Capybara gives error in IDE here, but works...
...
Capybara.configure do |config|
  # 2 minutes for ember app loading upp initially
